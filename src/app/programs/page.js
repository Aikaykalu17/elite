        ...
        <div className="rounded-tl-sm rounded-tr-sm bg-white py-6">
          <div className="w-[90%] mx-auto flex flex-col gap-8">
            <div className="flex flex-col gap-4">
              ...
              <Reveal>
                <div className="flex flex-col gap-4">
                  <h2 className="text-[#061426] font-bold">
                    TRIAL/TRYOUT INFO
                  </h2>
                  <div>
                  ...
                  >
                    <div className="relative w-full h-40 md:w-56 md:h-auto shrink-0">
                      <Image
                    ...
                    <div className="flex flex-col gap-2 p-2">
                      ...
                      <p className="text-xs">
                        <strong className="text-xs">What to bring:</strong>{" "}
                        Boots, Shin guards, Water, Towel
                      </p>
                    </div>
                  </article>
                </div>
