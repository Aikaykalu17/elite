          ...
          <div className=" w-[90%] mx-auto flex flex-col gap-8">
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-3 gap-2 ">
                <div className="flex flex-col items-center gap-2 border border-slate-300 p-4 w-full">
                  <span className="text-[#061426] font-bold">U-13</span>

                  <Baby size={35} color="#061426" />
                ...
                <div className="flex flex-col items-center gap-2 border border-slate-300 p-4 w-full">
                  ...
                  <UserRound size={35} color="#061426" />
                  <span className="text-[#061426] text-xs font-bold">
                    YOUTH
                  </span>
                </div>
                ...
                <div className="flex flex-col items-center gap-2 border border-slate-300 p-4 w-full">
                  ...
                  <ShieldCheck size={35} color="#061426" />
                  <span className="text-[#061426] text-xs font-bold">
                    Senior
                  </span>
                </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-4 border-b border-b-slate-200 pb-2">
                <HeartHandshake color="#F5B800" size={30} />
                <div className="flex flex-col gap-2">
