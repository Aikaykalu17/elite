...
function page() {
  return (
    <section className="w-full h-full mt-20">
      <div
        className="w-full text-white h-40 flex justify-center aspect-4/5 md:aspect-video  md:h-[40vh] lg:h-[90vh] bg-cover bg-center "
        style={{
      ...
      <div className=" bg-white h-full">
        <div className="w-[90%] mx-auto flex flex-col pt-6 pb-8 gap-4 md:gap-8">
          <div className="flex flex-col gap-4 md:grid md:grid-cols-2">
            <div className="md:flex md:flex-col md:gap-8">
              ...
              <p className="text-gray-500 text-xs font-bold">
                ...
                <br className="hidden md:block" /> a vision to raise
                disciplined, skilled and confident{" "}
                <br className="hidden md:block" /> young footballers who will
                excel both on and <br className="hidden md:block" /> off the
                pitch. We believe in hard work, integrity, teamwork, and{" "}
                <br className="hidden md:block" /> continuous growth.
              </p>
            </div>
            <Image
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4 md:flex md:flex-row md:w-full md:justify-between">
